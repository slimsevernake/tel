...
app.post(properties.api + '/login', function (req, res) {
    const db_tel_db = require('../db/tel_db_schema.js');
...
var createUser = function () {
    ...
    db_tel_db = require('../db/tel_db_schema.js');
    db_tel_db.User.count().exec(function (err, count) {
        if (count == 0) {
            var admin = new db_tel_db.User({
                username: 'admin',
